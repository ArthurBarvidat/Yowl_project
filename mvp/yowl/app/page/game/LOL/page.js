...
export default function CategoriesPage() {
  ...
  return (
    <main className="min-h-screen w-full max-w-xl mx-auto pb-10">
      <TopBar />
      <div className="px-4 pt-15">
        ...
        <h1 className="text-2xl font-semibold leading-none text-center">
          Choose your rank
        </h1>

        <p className="mt-1 text-sm  text-center">Find your mates</p>
      </div>
      <div className="pt-1">
        <LOL />
      </div>
